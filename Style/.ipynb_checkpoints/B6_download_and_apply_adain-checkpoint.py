...
os.system('python3 applystyle.py --content_dir ../Data/coco_data/train/ --style_dir Data/style_data/ --output ../Data/datasets/train/images/')

os.system('python3 applystyle.py --content_dir ../Data/coco_data/test/ --style_dir Data/style_data/ --output ../Data/datasets/test/images/')

os.system('python3 applystyle.py --content_dir ../Data/coco_data/val/ --style_dir Data/style_data/ --output ../Data/datasets/val/images/')
