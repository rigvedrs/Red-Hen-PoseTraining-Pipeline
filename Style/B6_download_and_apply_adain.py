...
os.system('python3 applystyle.py --content_dir ../Data/coco_data/train/ --style_dir ../Data/style_data/ --output ../Data/dataset/images/train/ --delete True')

os.system('python3 applystyle.py --content_dir ../Data/coco_data/test/ --style_dir ../Data/style_data/ --output ../Data/dataset/images/test/ --delete True')

os.system('python3 applystyle.py --content_dir ../Data/coco_data/val/ --style_dir ../Data/style_data/ --output ../Data/dataset/images/val/ --delete True')
